            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="me-auto">
                <NavDropdown title="Profile Pictures" id="collasible-nav-dropdown">
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="https://my-json-server.typicode.com/eddiehe49/profile-pictures/" target="_blank" rel="noopener noreferrer">JSON</NavDropdown.Item>
                </NavDropdown>
                <NavDropdown title="Favicon" id="collasible-nav-dropdown" variant="dark">
                  ...
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="https://my-json-server.typicode.com/eddiehe49/favicons/" target="_blank" rel="noopener noreferrer">JSON</NavDropdown.Item>
                </NavDropdown>
